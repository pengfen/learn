...
<div id="add">
    <a href="javascript:void(0)">添加角色</a>
    <input type='hidden' value="<?php echo U('Role/add');?>"/>
	...
	<table class="table table-striped">
	    ...
	    <tbody>
	    	<?php if(is_array($info)): foreach($info as $key=>$v): ?><tr>
	    		...
	    		<td>
	    		    <a class="detail" href="javascript:void(0);">查看权限</a>
				  	<input type="hidden" name="" value="<?php echo U('Role/detail', array('id'=>$v[id]));?>"/>
	    			<a class="upd" href="javascript:void(0);">分配权限</a>
				  	<input type="hidden" name="" value="<?php echo U('Role/distribute', array('id'=>$v[id]));?>"/>
				  	<a href="<?php echo U('Role/delete', array('id'=>$v[id]));?>">删除</a>
	    		</td>

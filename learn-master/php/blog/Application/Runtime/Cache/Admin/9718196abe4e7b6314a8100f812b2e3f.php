...
<html lang="en">
	...
	<div class="container containerDiv">
		<div class="row">
			...
			<div class="col-md-8">	
				<form action="<?php echo U('Manager/insert');?>" method="post" id="myform">
					<div class="form-group">
						<div class='int'>
							<lable for='username'>用 &nbsp;户 &nbsp;名：</lable>
							<input type='text' id='username' class='required' name='username' placeholder="请输入真实姓名"/>
						</div>
						<script> var url="<?php echo U('Manager/checkEmail');?>" </script>
						<div class='int'>
							邮 &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;箱：
							<input type='text' id='email' class='required' name='email' placeholder="请输入邮箱"/>
						</div>
						<div class='int'>
							职 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;位：
								&nbsp;&nbsp;
								<select name='rid'>
									<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value=<?php echo ($vo["rid"]); ?>><?php echo ($vo["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
								</select>
						</div>
						<div class='int'>
							密 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;码：

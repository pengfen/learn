						...
						<table class='table table-striped'>
							<thead>
								<tr>
									<td colspan='6'></td>
									<td colspan='2'>
										<b><a href="<?php echo U('Resource/index');?>" style='color:#87B87F'>查全部</a></b>
									</td>
								</tr>
								<tr>
									<th>编号</th>
							...
							<tbody class="managerMain">
								<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
										...
										<td><?php echo ($vo["header"]); ?></td>
										<td><?php echo htmlspecialchars_decode($vo['main']);?></td>
										<td><?php echo ($vo["download"]); ?></td>
										<td><?php echo ($vo["score"]); ?></td>
										<td><?php echo date('Y-m-d ',$vo['addtime']);?></td>
										<td><a href="<?php echo U('Resource/delete',array('id'=>$vo['id']));?>">删除</a></td>

...
<div id="add">
    ...
    <input type='hidden' name="" value="<?php echo U('News/add');?>"/>
</div>
	    	...
	    	<?php if(is_array($info)): foreach($info as $key=>$v): ?><tr>
	    		...
	    		<td>
	    			<a class="upd" href="javascript:void(0);">修改</a>
				  	<input type="hidden" name="" value="<?php echo U('News/edit', array('id'=>$v[id]));?>"/>
				  	<a href="<?php echo U('News/delete', array('id'=>$v[id]));?>">删除</a>
	    		</td>

...
<div id="add">
    <a href="javascript:void(0)">添加方法逻辑</a>
    <input type='hidden' value="<?php echo U('Logic/add');?>"/>
    <a href="<?php echo U('Logic/index');?>">返回方法逻辑列表</a>
</div>
	...
	<table class="table table-striped">
	    ...
	    <tbody>
	    	<?php if(is_array($info)): foreach($info as $key=>$v): ?><tr style="height:35px; line-height: 35px; overflow:hidden;">
	    		...
	    		<td>
	    		    <a class="detail" href="javascript:void(0)"><?php echo ($v["ac"]); ?></a>
	    			<input type="hidden" value="<?php echo U('Logic/detail', array('ac'=>$v[ac]));?>">
	    		</td>
	    		<td>
	    			<a class="detail" href="javascript:void(0)">详情</a>
	    			<input type="hidden" value="<?php echo U('Logic/detail', array('id'=>$v[id]));?>">
	    			<a class="upd" href="javascript:void(0);">修改</a>
				  	<input type="hidden" value="<?php echo U('Logic/edit', array('id'=>$v[id]));?>"/>
				  	<a href="<?php echo U('Logic/delete', array('id'=>$v[id]));?>">删除</a>
	    		</td>

	...
	<table class="table table-striped">
	    ...
	    <tbody>
	    	<?php if(is_array($info)): foreach($info as $key=>$v): ?><tr>
	    		<td><?php echo ($v["id"]); ?></td>
	    		<td>
	    		    <a class="detail" href="javascript:void(0)"><?php echo ($v["username"]); ?></a>
	    		...
	    		<td>
	    			...
	    			<input type="hidden" value="<?php echo U('User/detail', array('id'=>$v[id]));?>"/>
	    			<a class="detail" href="javascript:void(0)">会员课程</a>
	    			<input type="hidden" value="<?php echo U('User/detail', array('id'=>$v[id]));?>"/>
	    			<a class="detail" href="javascript:void(0)">会员课程评论</a>
	    			<input type="hidden" value="<?php echo U('User/detail', array('id'=>$v[id]));?>"/>
	    			<a class="detail" href="javascript:void(0)">会员笔记</a>
	    			<input type="hidden" value="<?php echo U('User/detail', array('id'=>$v[id]));?>"/>

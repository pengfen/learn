...
<div id="add">
    ...
    <input type='hidden' value="<?php echo U('Module/add');?>"/>
    <a href="<?php echo U('Module/index');?>">返回模块列表</a>
</div>
	    ...
	    <tbody>
	    	<?php if(is_array($info)): foreach($info as $key=>$v): ?><tr style="height:35px; line-height: 35px; overflow:hidden;">
	    		...
	    		<td>
	    			...
	    			<input type="hidden" value="<?php echo U('Module/detail', array('id'=>$v[id]));?>">
	    		</td>
	    		...
	    		<td>
	    			...
	    			<a class="upd" href="javascript:void(0);">修改</a>
				  	<input type="hidden" name="" value="<?php echo U('Module/edit', array('id'=>$v[id]));?>"/>
				  	<a href="<?php echo U('Module/delete', array('id'=>$v[id]));?>">删除</a>
	    		</td>

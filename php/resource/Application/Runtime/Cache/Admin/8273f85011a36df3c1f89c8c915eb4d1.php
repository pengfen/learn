...
<div id="add">
    ...
    <input type='hidden' value="<?php echo U('Techn/add');?>"/>
    <a href="<?php echo U('Techn/index');?>">返回文章列表</a>
</div>
	...
	<table class="table table-striped">
	    ...
	    <tbody>
	    	<?php if(is_array($info)): foreach($info as $key=>$v): ?><tr>
	    		...
	    		<td>
	    			<a class="add" href="javascript:void(0);">修改</a>
				  	<input type="hidden" name="" value="<?php echo U('Techn/edit', array('id'=>$v[id]));?>"/>
				  	<a class="upd" href="javascript:void(0);">文章详情</a>
				  	<input type="hidden" name="" value="<?php echo U('Techn/detail', array('id'=>$v[id]));?>"/>
				  	<a href="<?php echo U('Techn/del', array('id'=>$v[id]));?>">删除</a>
	    		</td>

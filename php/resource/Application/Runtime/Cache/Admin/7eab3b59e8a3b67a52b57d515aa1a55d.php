...
<form class="form-horizontal" id="add-direct">
    ...
    <div class="form-group">
        ...
        <button type="button" class="btn btn-default" id='addbtn'>添加技术方向</button>
        <input type="hidden" value="<?php echo U('Direct/insert');?>"/>

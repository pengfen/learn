...
<form class="form-horizontal" action="<?php echo U('Auth/update');?>" method="post">
<input type='hidden' name='id' value="<?php echo ($v["id"]); ?>"/>
    ...
    <?php if(is_array($info)): foreach($info as $key=>$av): ?><option value="<?php echo ($av["id"]); ?>" <?php if($av[id] == $v[pid]): ?>selected<?php endif; ?>><?php echo ($av["name"]); ?></option><?php endforeach; endif; ?>
...
<div class="form-group">
    ...
    <button type="submit" class="btn btn-default">修改权限</button>

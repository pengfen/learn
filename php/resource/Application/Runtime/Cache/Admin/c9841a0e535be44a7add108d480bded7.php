...
<div id="add">
    <!-- <a href="javascript:void(0)">添加团队人员</a>
    <input type='hidden' value="<?php echo U('Develop/add');?>"/> -->
    <a href="<?php echo U('ImageRecycle/index');?>">返回回收图片列表</a>
</div>
	    	...
	    	<?php if(is_array($info)): foreach($info as $key=>$v): ?><tr style="height:35px; line-height: 35px; overflow:hidden;">
	    		...
	    		<td>
	    		    <a class="detail" href="javascript:void(0)">
	    		    	<img src="/resource/Public/<?php echo ($v['image']); ?>" width="100" height="100" />
	    		    </a>
	    			<input type="hidden" value="<?php echo U('ImageRecycle/detail', array('id'=>$v[id]));?>">
	    		</td>
	    		...
	    		<td>
	    			...
	    			<input type="hidden" value="<?php echo U('ImageRecycle/detail', array('id'=>$v[id]));?>">
				  	<a href="<?php echo U('ImageRecycle/delete', array('id'=>$v[id]));?>">删除</a>
	    		</td>

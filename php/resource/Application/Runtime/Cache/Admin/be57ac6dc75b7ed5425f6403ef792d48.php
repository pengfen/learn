...
<div id="add">
    <?php if($flag == 0): ?><a href="javascript:void(0)">添加后台目录</a>
    <?php else: ?>
    <a href="javascript:void(0)">添加前台目录</a><?php endif; ?>
    <input type='hidden' value="<?php echo U('Dir/add', array('flag'=>$flag, 'pid'=>$pid));?>"/>
    <a href="<?php echo U('Dir/index');?>">目录列表</a>
</div>
	...
	<table class="table table-striped">
	    ...
	    <tbody>
	    	<?php if(is_array($info)): foreach($info as $key=>$v): ?><tr>
	    		...
	    		<td><a href='javascript:void(0);' class="dir"><?php echo ($v["name"]); ?></a><input type='hidden' value="<?php echo U('Dir/detail', array('id'=>$v[id]));?>"/></td>
	    		<td><?php echo ($v["controller"]); ?></td>
	    		<td>
	    			<a class="upd" href="javascript:void(0);">修改</a>
				  	<input type="hidden" name="" value="<?php echo U('Dir/edit', array('id'=>$v[id]));?>"/>
				  	<a href="<?php echo U('Dir/delete', array('id'=>$v[id]));?>">删除</a>
	    		</td>

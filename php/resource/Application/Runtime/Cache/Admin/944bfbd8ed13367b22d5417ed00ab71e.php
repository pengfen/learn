...
<form class="form-horizontal" action="<?php echo U('Techn/insert');?>" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <select name='pid'>
            ...
            <?php if(is_array($cateinfo)): foreach($cateinfo as $key=>$av): ?><option value="<?php echo ($key); ?>"><?php echo ($av); ?></option><?php endforeach; endif; ?>

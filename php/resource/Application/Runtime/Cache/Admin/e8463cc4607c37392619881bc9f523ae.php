...
<div id="add">
    ...
    <input type='hidden' value="<?php echo U('Categorys/add');?>"/>
    <a href="<?php echo U('Categorys/index');?>">返回分类列表</a>
</div>
	...
	<table class="table table-striped">
	    ...
	    <tbody>
	    	<?php if(is_array($info)): foreach($info as $key=>$v): ?><tr style="height:35px; line-height: 35px; overflow:hidden;">
	    		...
	    		<td>
	    		    <a class="detail" href="javascript:void(0)"><?php echo ($v["catename"]); ?></a>
	    			<input type="hidden" value="<?php echo U('Categorys/detail', array('id'=>$v[id]));?>">
	    		</td>
	    		...
	    		<td>
	    			...
	    			<input type="hidden" value="<?php echo U('Categorys/detail', array('id'=>$v[id]));?>"> -->
	    			<a class='add-child' href="javascript:void(0)">添加子分类</a>
                    <input type='hidden' value="<?php echo U('Categorys/add', array('id'=>$v[id], 'name'=>$v[catename]));?>"/>
	    			<a class="upd" href="javascript:void(0);">修改</a>
				  	<input type="hidden" value="<?php echo U('Categorys/edit', array('id'=>$v[id]));?>"/>
				  	<a href="<?php echo U('Categorys/delete', array('id'=>$v[id]));?>">删除</a>
	    		</td>

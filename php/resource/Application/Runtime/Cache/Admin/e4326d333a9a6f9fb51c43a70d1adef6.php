...
<div id="add">
    <a href="javascript:void(0)">添加顶级分类</a>
    <input type='hidden' value="<?php echo U('TechnCate/add');?>"/>
</div>
	...
	<table class="table table-striped">
	    ...
	    <tbody>
	    	<?php if(is_array($info)): foreach($info as $key=>$v): ?><tr>
	    		...
	    		<td>
	    			<a class="add" href="javascript:void(0);">添加子分类</a>
				  	<input type="hidden" name="" value="<?php echo U('TechnCate/add', array('id'=>$v[id]));?>"/>
				  	<a class="upd" href="javascript:void(0);">修改</a>
				  	<input type="hidden" name="" value="<?php echo U('TechnCate/edit', array('id'=>$v[id]));?>"/>
				  	<a href="<?php echo U('TechnCate/del', array('id'=>$v[id]));?>">删除</a>
	    		</td>

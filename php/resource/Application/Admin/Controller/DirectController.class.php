...
class DirectController extends BaseController{
	...
	public function delete(){
		$id = I('get.id');
		$res = D('Direct') -> delete($id);
		$mess = new MessController();
		$mess -> message($res, '删除成功', '删除失败', U('Direct/index', array('mess'=>'删除成功')));
	}
}
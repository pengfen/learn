...
<html lang="zh-CN">
  <head>
   ...
   <style>
    ...
    <script type='text/javascript' src="/Public/Home/Js/jquery.nivo.slider.js"></script> 
    ...
    <div class="" style="margin-top:20px;">
      ...
      <div id="slider-wrapper"> 
        <div id="slider" class="nivoSlider"> 
                <a href="#" title="Featured Slide" target="_blank"><img src="/Public/Home/Images/1.jpg" alt=""  title="来畅享玩冒险"  /> </a> 
                    <a href="#" title="Slide With Caption" target="_blank"><img src="/Public/Home/Images/2.jpg" alt=""  title="来畅享看奇闻 "  /> </a> 
                    <a href="#" title="Aenean sagittis aliquam leo ut aliquet" target="_blank"><img src="/Public/Home/Images/3.jpg" alt=""  title="来畅享品美食"  /> </a> 
                    <a href="#" title="Lorem Ipsum" target="_blank"><img src="/Public/Home/Images/4.jpg" alt=""  title="来畅享看美女"  /> </a>
                  </div> 
    ...
    <div class="row">
      <div class="col-md-2" id='con_left'>
        <div class="row " >
          ...
          <img src="/Avatar/<?php echo ($src); ?>" alt="..." class="img-circle" id='head_img' width=150/>
    ...
    <?php echo ($user['experience']); ?>
      ...
      <div class="row">
        ...
        <?php if(is_array($vlist)): $i = 0; $__LIST__ = $vlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
              ...
              <img src='/Avatar/<?php echo ($vo["head"]); ?>' width="40" /><br>
              <a href='/index.php/Home/User/myhome/id/<?php echo ($vo["visitor"]); ?>'><?php echo ($vo["username"]); ?></a>
          ...
          <div class="panel panel-default">
            ...
            <div class="panel-body">
              ...
              <?php if(is_array($newslist)): $i = 0; $__LIST__ = $newslist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class="list-group-item">
                  <a href="/index.php/Home/News/index/newsid/<?php echo ($vo["id"]); ?>.html"><?php echo ($vo["title"]); ?></a>
                </li><?php endforeach; endif; else: echo "" ;endif; ?>
              </ul>
            </div>
          </div>

...
<div id = 'right' class="col-md-10">
	<table class="table table-striped">
	    <thead>
	    	<tr>
	    		<td colspan='6'><td>
	    		<b><td colspan='2'><a href="<?php echo U('Album/index');?>" style='color:#87B87F'>查全部</a><td></b>
	    	</tr>
	    	<tr>
	    		<th>编号</th>
	    		<th>相册名</th>
	    ...
	    <tbody>
	    	<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
	    		<td><a href="<?php echo U('Photo/index',array('aid'=>$vo['id']));?>"><?php echo ($vo["id"]); ?></a></td>
	    		<td><?php echo ($vo["album_name"]); ?></td>
	    		<td><img src="/blog/Uploads/<?php echo ($vo["first"]); ?>" width=60></td>
	    		<td><?php echo ($vo["des"]); ?></td>
	    		<td><?php echo ($vo["scan"]); ?></td>
	    		<td><?php echo ($vo["uid"]); ?></td>
	    		<td><?php echo date('Y-m-d H:i:s',$vo['create_time']);?></td>
	    		<td><a href="<?php echo U('Album/edit',array('id'=>$vo['id']));?>">编辑</a></td><?php endforeach; endif; else: echo "" ;endif; ?>
